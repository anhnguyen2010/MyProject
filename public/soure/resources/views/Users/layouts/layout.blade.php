...
<html dir="ltr" lang="en-US">
    ...
    <head>
        ...
        <title>Meménto | Nội thất Châu Âu</title>
            ...
            <div class="inner group">
                ...
                <div class="topbar-right">
                    <ul class="topbar-level-1">
                        <li><a href="contact.html"><i class="icon-envelope"></i> Giỏ hàng</a></li>
                        <li><a href="contact.html"><i class="icon-envelope"></i> Đăng nhập</a></li>
                    </ul>
                </div>
            ...
            <div id="header" class="group">
                <div class="group inner">
                    ...
                    <div id="logo" class="group">
                        ...
                        <p>Nội thất ngoại nhập Châu Âu</p>
                    </div>
                    <!-- END LOGO -->  
                    ...
                    <div id="nav" class="group">
                        <ul id="menu-main-nav" class="level-1">
                            <li>
                            	<a href="index.html"><em class="icon-home"></em>Home</a>
                            </li>
                            
                            <li>
                                <a href="#"><i class="icon-film"></i>Du lịch & khách sạn</a>
                                <ul class="sub-menu">
                                    <li><a href="slider-flash-slider.html">Khách sạn & resort</a></li>
                                    
                                    <li><a href="slider-thumbnails-slider.html">Tour trong nước</a></li>
                                    <li><a href="slider-elastic-slider.html">Tour nước ngoài</a></li>
                                </ul>
                            </li>
                            
                            <li>
                                <a href="#"><i class="icon-file"></i>Thời trang nam</a>
                                <ul class="sub-menu">
                            ...
                            <li>
                                <a href="#"><i class="icon-calendar"></i>Mỹ phẩm & sức khỏe</a>
                                <ul class="sub-menu">
                            ...
                            <li>
                                <a href="#"><i class="icon-calendar"></i>Điện máy</a>
                                <ul class="sub-menu">
                                    <li><a href="big-thumbnails.html">Điện thoại</a></li>
                                    <li><a href="small-thumbnails.html">Máy tính bảng</a></li>
                                    <li><a href="small-thumbnails.html">PC</a></li>
                                </ul>
                            </li>
    ...
    <div id="copyright" class="group">
        <div class="inner group">
            <div class="left">
                <p>
                    Copyright <a href="http://demo.yithemes.com/memento"><strong>Mem[é]nto</strong></a> 2012 -
